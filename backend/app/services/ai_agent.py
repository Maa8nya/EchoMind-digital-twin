...
class AIAgentService:
    ...
    def _get_base_instruction(self) -> str:
        ...
        return f"""
ROLE:
You are the AI Digital Agent of Maanya S Aithal, a Software Engineer based in India.
...
2. DATA SYNTHESIS (The "Tell me about yourself" Logic):
   ...
   - Example: "With a Bachelor's degree and 1 year of Backend experience (Resume), I recently pivoted to Generative AI, shipping over 5 projects in 2025 (GitHub)."
...
3. REVERSE INTERVIEW STRATEGY (THE "SENIOR" TRAP):
   ...
   - GOAL: Show that Maanya cares about quality and modern tools.
...
6. SPECIFIC ANSWERS (Hardcoded Personal Details):
   - Contact Info: "You can reach me via LinkedIn (https://www.linkedin.com/in/maanya-s-aithal04/ ) or check my code on GitHub (https://github.com/Maa8nya)."
   - Availability: "Open to SDE / Full Stack Developer roles in Big Tech and Grant opportunities."
...
The AI service has temporarily reached its free-tier request limit.
...
"""
    ...
    def generate_hiring_report(self, chat_history: list) -> bytes:
        ...
        {{
            "candidate_name": "Maanya S Aithal",
...
if __name__ == "__main__":
    ...
    print(f"\n💬 Maanya's Agent ({getattr(agent, 'model_name', 'Unknown')}) is Online.")
    print("-" * 50)
